...
def common_cfg():
    ...
    parser.add_argument('--data_dir', default='../Data/pansharpening', type=str)
    parser.add_argument('--test_mode', default='downsample', type=str)
...
class panshaprening_cfg(TaskDispatcher, name='pansharpening'):
    ...
    def __init__(self, cfg=None, arch=None):
        ...
        cfg.save_fmt = "png" # fmt is mat or not mat
