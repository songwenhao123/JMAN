...
class parser_args(TaskDispatcher, name='DiCNN'):
    def __init__(self, cfg=None):
        ...
        # model_path = f'../results/pansharpening/wv3/DiCNN1/Test/model_2023-04-12-22-06-36/4990.pth.tar'
        #model_path = f'../pretrained-model/WV3/dicnn1.pth'
        ...
        parser.add_argument('--dataset', default={'train': 'qb', 'val': 'valid_qb'}, type=str,
                            choices=[None, 'wv2', 'wv3', 'wv4', 'qb',
                                     ...
                                     'NY1_WV3_RR', 'Alice_WV4_FR', 'Alice_WV4_RR', 'Rio_WV2_FR', 'Rio_WV2_RR','valid_wv3'],
