...
class parser_args(TaskDispatcher, name='ours'):
    def __init__(self, cfg=None):
        ...
        model_path = f'../results/pansharpening/wv3/ours/Test/model_2023-04-11-17-59-53/1000.pth.tar'
        ...
        # * Model and Dataset
        parser.add_argument('--arch', '-a', metavar='ARCH', default='ours', type=str,
        ...
        parser.add_argument('--dataset', default={'train': 'wv3', 'val': 'valid_wv3'}, type=str,
                            choices=[None, 'wv2', 'wv3', 'wv4', 'qb',
                                     ...
                                     'NY1_WV3_RR', 'Alice_WV4_FR', 'Alice_WV4_RR', 'Rio_WV2_FR', 'Rio_WV2_RR','test_wv3_multiExm1'],
