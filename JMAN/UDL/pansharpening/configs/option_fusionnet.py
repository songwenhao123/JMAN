...
class parser_args(TaskDispatcher, name='FusionNet'):
    def __init__(self, cfg=None):
        ...
        #model_path = f'../results/pansharpening/wv3/FusionNet/Test/model_2023-04-12-15-26-01/396.pth.tar'
        model_path = f'{root_dir}/results/{cfg.task}/wv3/DRPNN/Test/.pth.tar'

        # TODO: Double check the model path
        # model_path = f'./.pth.tar'
        # model_path = f'./pretrained-model/WV3/fusionnet.pth'
