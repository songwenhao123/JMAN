...
class parser_args(TaskDispatcher, name='DRPNN'):
    def __init__(self, cfg=None):
        ...
        model_path = f'{root_dir}/results/{cfg.task}/gf2/DRPNN/Test/.pth.tar'
        # model_path = f'../results/pansharpening/wv3/DRPNN/Test/model_2023-04-12-22-37-28/490.pth.tar'
        ...
        parser.add_argument('--dataset', default={'train': 'gf2', 'val': 'valid_gf2'}, type=str,
